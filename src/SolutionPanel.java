...
public class SolutionPanel extends JPanel{
	...
	public SolutionPanel(BagOfWords ham, BagOfWords spam){
		...
		this.hamShowDirectoryChooserButton = new FolderChooser("Open Directory", this.ham, this.hamTable, this.hamTotalWordsLabel);
		this.hamShowDirectoryChooserButton.setFocusable(false);
		this.spamShowDirectoryChooserButton = new FolderChooser("Open Directory", this.spam, this.spamTable, this.spamTotalWordsLabel);
		...
		rightPanel.add(this.spamTotalWordsLabel, BorderLayout.SOUTH);
